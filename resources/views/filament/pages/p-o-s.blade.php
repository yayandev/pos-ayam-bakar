    ...
    <div class="flex w-full gap-10 md:gap-5 flex-col-reverse md:flex-row box-border items-start">
        ...
        <x-filament::section class="flex-1">
            ...
            <div class="border-b border-gray-200 mb-3">
                <nav class="-mb-px flex space-x-4" aria-label="Tabs">
                    <!-- Tab Makanan -->
                    <a href="javascript:void(0);" wire:click="setCategory('makanan')"
                    ...
                    <!-- Tab Minuman -->
                    <a href="javascript:void(0);" wire:click="setCategory('minuman')"
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm
        ...
        <x-filament::section class="w-full md:w-80">
            ...
            <form wire:submit.prevent="saveTransaction">
                <div class="mb-3">
                    <label for="transaction_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                        ID Transaksi
                    </label>
                    <x-filament::input.wrapper>
                ...
                @if ($transactionId)
                    <p class="text-sm text-yellow-500 font-semibold mb-2">
                        Anda sedang mengedit transaksi dengan ID: {{ $transactionId }}
                    </p>
                @endif
                ...
                <!-- Daftar Pesanan -->
                @if (count($cart) > 0)
                    <ul class="mt-4 w-full overflow-y-auto max-h-48">
                ...
                <div class="space-y-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="payment_method" wire:model.live="paymentMethod" id=""
                            class="focus:outline-red-500 w-full p-2 border border-gray-300 dark:border-gray-600 rounded focus:outline-none dark:bg-gray-800 dark:text-white">
                    ...
                    @if ($paymentMethod == 'cash')
                        <div class="mb-3">
                            <label for="moneyPaid" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                                Uang Pembayaran
                            </label>
                            <x-filament::input.wrapper>
                ...
                <!-- Edit Transaksi -->
                @if ($transactionId)
                    <x-filament::button wire:click="editTransactionAndPrintReceipt" type="button" color="primary"
                        class="w-full mt-3">
                        Bayar
                    </x-filament::button>
                    <x-filament::button wire:click="editTransaction" type="button" color="warning" class="w-full mt-3">
                        Edit Transaksi
                    </x-filament::button>
                @else
                    <x-filament::button wire:click="saveTransaction" type="button" color="primary" class="w-full mt-3">
                        Bayar
                    </x-filament::button>
                    <x-filament::button wire:click="orderTransaction" type="button" color="secondary"
                        class="w-full mt-3">
                        Order
                    </x-filament::button>
                @endif
